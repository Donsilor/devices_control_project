(function() {
     ...
     */
    function iosCall(method, data, callback, flag) {
     ...
     * android jsbridge实现
     */
    function androidCall(method, data, callback, flag) {
     ...
     *原生安卓桥接对象
     * **/
    function androidCallEvents(method, data) {
