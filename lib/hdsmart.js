(function() {
    ...
    sdk.Device = {
        ...
        control: function(options, success, fail) {
            ...
            //通道参数
            var channel = CHANNEL_DICTIONARY[opt.method];
            ...
            var option = { channel, content: opt };

            bridge.sendEvent(apiList.device_control, option, function(data) {
                if (data.msg == 'TcpClient send msg success') {
                    if (data.req_id) option.content.req_id = data.req_id;
