<template>
   <!-- 告警按钮-->
    <div class="alertButton" v-if="alertModel.length>0" @click = "goAlertpage">
        <div class="outer">
            <div class="inner"> 
                <img src="./assets/btn_airouter_alarm_red@2x.png" />
...
<style lang="less">
    ...
    .alertButton{
        ...
        .outer{
            ...
            // opacity: 0.25;
            // background: #F26161;
            background:rgba(242,97,97,0.25);
            .inner{
                width:76px;
                height: 76px;
                position: relative;
