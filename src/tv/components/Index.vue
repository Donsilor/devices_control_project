            ...
            <div class="grid">
                <div class="content-con">
                    ...
                    <div class="span-right">
                        <div class="span3">
                            <router-link v-for="item in channels_1" :key="item.channelId" :to="{
                    name: 'list',
                    query: {
                        ...
                        <div class="span3">
                            <router-link v-for="item in channels_2" :key="item.channelId" :to="{
                    name: 'list',
                    query: {
                        channelId: item.channelId,
                        channel: item.channel
...
.grid {
    ...
    .item-search {
        background-image: url(../../../lib/base/tv/assets/icn_tv_search.png);
    }
    .item-tp {
        background-image: url(../../../lib/base/tv/assets/icn_tv_sync.png);
    }
    .item-ykq {
        background-image: url(../../../lib/base/tv/assets/icn_tv_remote.png);
    }
    .item-001 {
...
.control {
    ...
    .home {
        background-image: url(../../../lib/base/tv/assets/btn_remote_home_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_home_pressed.png);
        }
    }
    .back {
        background-image: url(../../../lib/base/tv/assets/btn_remote_back_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_back_pressed.png);
        }
    }
    .volup {
        background-image: url(../../../lib/base/tv/assets/btn_remote_volumeup_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_volumeup_pressed.png);
        }
    }
    .menu {
        background-image: url(../../../lib/base/tv/assets/btn_remote_menu_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_menu_pressed.png);
        }
    }
    .voldown {
        background-image: url(../../../lib/base/tv/assets/btn_remote_volumedown_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_volumedown_pressed.png);
        }
    }
    .shut {
        background-image: url(../../../lib/base/tv/assets/btn_remote_power_normal.png);
        &:active {
            background-image: url(../../../lib/base/tv/assets/btn_remote_power_pressed.png);
        }
    }
}
</style>
