    ...
    <div
      ...
      <div class="icon_grid_inner">
        <div
          ...
          @click.prevent="toActive(item,idx)">{{ item.channel }}
        </div>
        <div class="block"/>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      volupEnd(e) {
        ...
        // }
        // e.preventDefault()
        this.endFn(e, this.timeOutEventUp, 'rcVolumeUpStop', 'rcVolumeUp', 'timeOutEventUp')
      },
      voldownEnd(e) {
        ...
        // }
        // e.preventDefault()
        this.endFn(e, this.timeOutEventDown, 'rcVolumeDownStop', 'rcVolumeDown', 'timeOutEventDown')
      },
      cmd(name) {
