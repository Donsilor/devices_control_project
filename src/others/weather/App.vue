<template>
  <div 
    ...
    <template v-if="showSwitchCity">
      <switchCity 
        :city="city" 
        :get-city-weather="getCityWeather" 
        :tody-class="todyClass" 
        @hideswitch="hideSwitchCity"/>
    </template>
    <!--城市切换-->
    <template v-else>
      <span 
        class="weather-close" 
        @click.prevent="close">关闭</span>
      <span 
        v-if="success" 
        class="switch" 
        @click="switchCity">
      ...
      <template v-if="success">
        <div class="city">
          <div 
            class="city-name" 
            style="margin-top: 10px">{{ city.name }}</div>
          <div>
            <span 
              :class="curMinBg" 
              class="img"/>
        ...
        <div class="weather-list-con">
          <ul class="weather-list">
            <li 
              ...
              <div class="w-icon">
                <i :class="renderClass(item.conditionIdDay)"/>
              </div>
