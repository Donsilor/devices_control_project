...
.detail-info {
    .control {
        ...
        .back {
            background-image: url(../../../lib/base/tv/assets/icn_remote_back_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_back_pressed.png);
            }
        }
        .volup {
            background-image: url(../../../lib/base/tv/assets/icn_remote_volumeup_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_volumeup_pressed.png);
            }
        }
        .remote {
            background-image: url(../../../lib/base/tv/assets/icn_remote_playpause_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_playpause_pressed.png);
            }
        }
        .ok {
            background-image: url(../../../lib/base/tv/assets/icn_remote_ok_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_ok_pressed.png);
            }
        }
        .voldown {
            background-image: url(../../../lib/base/tv/assets/icn_remote_volumedown_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_volumedown_pressed.png);
            }
        }
        .shut {
            background-image: url(../../../lib/base/tv/assets/icn_remote_power_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_power_pressed.png);
            }
        }
        .left {
            background-image: url(../../../lib/base/tv/assets/icn_remote_left_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_left_pressed.png);
            }
        }
        .right {
            background-image: url(../../../lib/base/tv/assets/icn_remote_right_normal.png);
            &:active {
                background-image: url(../../../lib/base/tv/assets/icn_remote_right_pressed.png);
            }
        }
    }
    margin: 0 60px 35px;
    ...
    .pic {
        ...
        img {
            ...
            &.pic-004 {
                background-image: url(../../../lib/base/tv/assets/icn_tv_entertainment.png);
            }
        }
        [lazy="loaded"] {
            opacity: 1;
...
.detail-playlist {
    ...
    .tag_new {
        width: 72px;
        height: 72px;
        background: url(../../../lib/base/tv/assets/tag_tv_new.png) no-repeat;
        background-size: 100%;
        position: absolute;
        right: 0;
        top: 0;
    ...
    .tag_pay {
        width: 72px;
        height: 72px;
        background: url(../../../lib/base/tv/assets/tv_fee.png) no-repeat;
        background-size: 100%;
        position: absolute;
        right: 0;
        top: 0;
