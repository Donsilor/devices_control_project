<template>
  <div class="calendar">
    ...
    <div class="calendar-body">
      ...
      <div 
        v-for="days in dayRows" 
        class="calendar-row calendar-date">
        <div 
          v-for="day in days" 
          class="calendar-cell calendar-cell-date">
          <div 
            v-if="day" 
...
.calendar-title:before {
    content: "";
    background: url("../../../lib/base/door_sensor/assets/icn_calender_s.png");
    width: 35px;
    height: 31px;
...
.btn-pre-month {
    background: url("../../../lib/base/door_sensor/assets/btn_calendar_pre_normal.png")
...
.btn-pre-month:active {
    background-image: url("../../../lib/base/door_sensor/assets/btn_calendar_pre_pressed.png");
}
...
.btn-next-month {
    background: url("../../../lib/base/door_sensor/assets/btn_calendar_next_normal.png")
        center center no-repeat;
    width: 48px;
    height: 48px;
    line-height: 48px;
...
.btn-next-month:active {
    background-image: url("../../../lib/base/door_sensor/assets/btn_calendar_next_pressed.png");
}
</style>
<script>
