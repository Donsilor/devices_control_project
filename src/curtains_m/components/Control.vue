...
.on {
    background: url("../../../lib/base/curtains/assets/btn_curtain_open_normal@2x.png")
        center center no-repeat;
}

.on.normal:active {
    background-image: url("../../../lib/base/curtains/assets/btn_curtain_open_pressed@2x.png");
}

.pause {
    background: url("../../../lib/base/curtains/assets/btn_curtain_pause_normal@2x.png")
        center center no-repeat;
}

.pause.normal:active {
    background-image: url("../../../lib/base/curtains/assets/btn_curtain_pause_pressed@2x.png");
}

.off {
    background: url("../../../lib/base/curtains/assets/btn_curtain_close_normal@2x.png")
        center center no-repeat;
}

.off.normal:active {
    background-image: url("../../../lib/base/curtains/assets/btn_curtain_close_pressed@2x.png");
}

.loading {
    position: relative;
    background-image: url("../../../lib/base/curtains/assets/btn_curtain_buffering@2x.png");
}
