  ...
  <div id="app">
    ...
    <div 
      ...
      <div class="controls">
        ...
        <i class="c-model"/>模式设定</button>
        <button @click="showModelLayer">
        <i class="c-preheat"/>辅助预热</button>
        <button @click="showModelBarbicueTime">
        <i class="c-barbicue"/>预约烧烤</button>
      </div>
      <!-- 查看更多的按钮 -->
      <span 
        class="more-btn" 
      ...
      <!-- 预约烘烤时间弹窗 -->
      <modal 
        v-model="barbicueTimeAlert" 
        title="预约烧烤结束时间" 
        class="subpagebakControl2">
        <mt-datetime-picker 
          ref="picker" 
          :clock-start-data="barbicueTimestart" 
          :clock-end-data="barbicueTimeend" 
          :item-height="50" 
        ...
        <div class="buttongroup">
          <div 
            class="cancle" 
            @click="barbicueTimeAlert = false">取消</div>
          <div 
            class="sure" 
            @click="handleChange">确定</div>
        </div>
      </modal>
    </div>
    ...
    <sub-page 
      ...
      class="model-select-layer backControl" 
      title="模式">
      <div 
        ...
        <modal 
          ...
          <picker 
            ...
            @change="selectWendu"/>
          <div 
            class="button_temperature" 
            @click="wenduSelectFlag = false">完成</div>
        </modal>
        ...
        <modal 
          ...
          <div 
            class="button_temperature" 
            @click="timeSelectFlag = false">预约</div>
        </modal>
...
<style lang="less">
@imgPath: 'base/haier_oven/assets';
@imgPath1: 'base/washer/assets';
@imgPath2: 'base/oven/assets';
html,
body {
    margin: 0;
    height: 100%;
...
.page-off {
    ...
    .oven {
        ...
        background: url('~@lib/@{imgPath}/img_ovenline@2x.png') no-repeat;
    ...
    .off_button {
        ...
        a {
            ...
            i {
                ...
                height: 100%;
                display: block;
                background: url('~@lib/@{imgPath1}/btn_power@2x.png') no-repeat center;
                background-size: 100% 100%;
            }
        }
    }
...
.more-btn {
    ...
    height: 36px;
    top: 166px;
    background-image: url('~@lib/@{imgPath2}/btn_more@2x.png');
    background-size: 100% 100%;
}
.wrapper {
    width: 100%;
    ...
    .offButton {
        ...
        button {
            ...
            .c-stop {
                background-image: url('~@lib/@{imgPath}/icn_shutdown_active@2x.png');
                &.disable {
                    background-image: url('~@lib/@{imgPath}/icn_shutdown_disabled@2x.png');
                }
            }
            .c-model {
                background-image: url('~@lib/@{imgPath}/icn_modepreset_active@2x.png');
            }
            .c-firing {
                background-image: url('~@lib/@{imgPath}/icn_open_active@2x.png');
            }
            .c-preheat {
                background-image: url('~@lib/@{imgPath}/icn_Auxiliarywa-up_active@2x.png');
            }
            .c-barbicue {
                background-image: url('~@lib/@{imgPath}/icn_reservebaking_active@2x.png');
            }
        }
    }
}
    ...
    .disable {
        ...
        li {
            ...
            a.traditional-baking {
                background-image: url('~@lib/@{imgPath2}/btn_bread_g.png');
            }
            a.ico-3d {
                background-image: url('~@lib/@{imgPath2}/btn_biscuits_g.png');
            }
            a.ico-convective-baking {
                background-image: url('~@lib/@{imgPath2}/btn_cake_g.png');
            }
            a.ico-barking {
                background-image: url('~@lib/@{imgPath2}/btn_pizza_g.png');
            }
            a.ico-hot-air-barbecue {
                background-image: url('~@lib/@{imgPath2}/btn_barbecue_g.png');
            }
            a.ico-up-barbecue {
                background-image: url('~@lib/@{imgPath2}/btn_fishandshrimp_g.png');
            }
            a.ico-whole-barbecue {
                background-image: url('~@lib/@{imgPath2}/btn_pachyrhizus_g.png');
            }
            a.ico-pizza {
                background-image: url('~@lib/@{imgPath2}/btn_chicken_g.png');
            }
        }
    }
    .model-list {
        ...
        li {
            ...
            .traditional-baking {
                background-image: url('~@lib/@{imgPath}/icn_traditionalbaking_norma.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_traditionalbaking_active@2x.png');
                }
            }
            .ico-3d {
                background-image: url('~@lib/@{imgPath}/icn_3Dhotair_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_3Dhotair_active@2x.png');
                }
            }
            .ico-convective-baking {
                background-image: url('~@lib/@{imgPath}/icn_convectionbake_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_convectionbake_active@2x.png');
                }
            }
            .ico-barking {
                background-image: url('~@lib/@{imgPath}/icn_baking_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_baking_active@2x.png');
                }
            }
            .ico-hot-air-barbecue {
                background-image: url('~@lib/@{imgPath}/icn_hotairbarbecue_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_hotairbarbecue_active@2x.png');
                }
            }
            .ico-up-barbecue {
                background-image: url('~@lib/@{imgPath}/icn_upthebarbecue_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_upthebarbecue_active@2x.png');
                }
            }
            .ico-whole-barbecue {
                background-image: url('~@lib/@{imgPath}/icn_wholebarbecue_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_wholebarbecue_active@2x.png');
                }
            }
            .ico-pizza {
                background-image: url('~@lib/@{imgPath}/icn_pizzamode_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_pizzamode_active@2x.png');
                }
            }
            .ico-pizza {
                background-image: url('~@lib/@{imgPath}/icn_pizzamode_normal@2x.png');
            ...
            .ico-upper-fermentation {
                background-image: url('~@lib/@{imgPath}/icn_fermentation_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_fermentation_active@2x.png');
                }
            }
            .icon-thaw {
                background-image: url('~@lib/@{imgPath}/icn_thaw_normal@2x.png');
                &.active {
                    background-image: url('~@lib/@{imgPath}/icn_thaw_active@2x.png');
                }
            }
        }
    }
...
.select-param {
    ...
    .value-wendu {
        ...
        .icon-arrow-down {
            ...
            background-image: url('~@lib/@{imgPath2}/arrow_down.png');
        }
        .icon-arrow-up {
            background-image: url('~@lib/@{imgPath2}/arrow_up.png');
        }
    }
    .vue-js-switch {
        float: right;
...
#app .subpagebakControl {
    ...
    .buttonchoose {
        ...
        .pattern {
            ...
            .c-lighting {
                background: url('~@lib/@{imgPath}/icn_illumination_normal@2x.png') no-repeat center center;
                background-size: 100% 100%;
            }
            .c-time {
                background: url('~@lib/@{imgPath}/icn_timesynchronization_normal@2x.png') no-repeat center center;
                background-size: 100% 100%;
            }
        }
    }
    .selectbox {
        ...
        .hd {
            ...
            .arrow {
                ...
                width: 30px;
                height: 30px;
                background: url('~@lib/@{imgPath1}/arrow_down.png') no-repeat;
                background-size: 100% 100%;
                vertical-align: -6px;
                margin-left: 10px;
            }
