    ...
    .password-input-container {
        ...
        .password-input-title {
            ...
            .close {
                ...
                top: 27px;
                right: 26px;
                background: url(../../../lib/base/door_lock/assets/btn_close_normal.png)
                    no-repeat;
        ...
        .password-input-content {
            ...
            .del {
                ...
                right: 84px;
                top: 54px;
                background: url(../../../lib/base/door_lock/assets/btn_input_back_normal.png)
                    no-repeat;
                background-size: 48px;
                &:active {
                    background-image: url(../../../lib/base/door_lock/assets/btn_input_back_pressed.png);
                }
            }
            .password-input-btns {
                padding-left: 12px;
