    ...
    >
      <ul class="btns">
        <li :class="{'on':air_drying == 'on'}">
          <a
            :class="{'on':air_drying == 'on'}"
            href="#"
            class="icon-wind"
            @click.prevent="setWind"
          />
          风干
        </li>
        <li :class="{'on':drying == 'on'}">
          <a
            ...
            href="#"
            class="icon-bake"
            @click.prevent="setBake"
          />
          烘干
        </li>
        <li :class="{'on':sterilization == 'on'}">
          <a
            :class="{'on':sterilization == 'on'}"
            href="#"
            class="icon-sterilize"
            @click.prevent="setSterilize"
          />
          杀菌
        </li>
      </ul>
