...
.status_bar .arr{
    width: 22px;
    height: 12px;
    background: url(../assets/icn_arrow_down_blue.png) no-repeat;
    background-size: 100% 100%;
...
export default {
    ...
    computed: {
        ...
        spStatusText(){
            return ['', '图片', '视频', '音乐'][this.tvStatus.screenProjectType]
        },
        spVisible() {
            return this.tvStatus.tvOnlineStatus==1 && this.tvStatus.screenProjectType!=0 && this.$route.name!='search'
        },
        visible() {
