...
.subHeader .sub-close {
    ...
    top: 26px;
    right: 26px;
    background: url("../../lib/base/air_condition/assets/close.png") no-repeat;
...
.sleep {
    .imgWrapper {
        background-image: url(../../lib/base/air_condition/assets/sleep_normal.png);
    }
    &.active .imgWrapper {
        background-image: url(../../lib/base/air_condition/assets/sleep_active.png);
    }
}
