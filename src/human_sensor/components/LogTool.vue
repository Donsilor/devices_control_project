...
export default {
    ...
    methods: {
        ...
        reset() {
            this.$store.commit(
                "chooseDate",
                +new Date(this.source_time * 1000)
            );
        },
...
.btn-top {
    background: url("../../../lib/base/human_sensor/assets/btn_backtotop_normal.png")
...
.btn-calendar {
    background: url("../../../lib/base/human_sensor/assets/btn_calendar_normal.png")
        center center no-repeat;
    width: 96px;
    height: 96px;
    background-size: 100% 100%;
