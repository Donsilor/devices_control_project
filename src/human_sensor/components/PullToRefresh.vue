...
@keyframes loading {
    0% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_01.png");
    }
    6.25% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_02.png");
    }
    12.5% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_03.png");
    }
    18.75% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_04.png");
    }
    25% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_05.png");
    }
    31.25% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_06.png");
    }
    37.5% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_07.png");
    }
    43.75% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_08.png");
    }
    50% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_09.png");
    }
    56.25% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_10.png");
    }
    62.5% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_11.png");
    }
    68.75% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_12.png");
    }
    75% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_13.png");
    }
    81.25% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_14.png");
    }
    87.5% {
        background-image: url("../../../lib/base/human_sensor/assets/icn_loading_14.png");
    }
...
<script>
import AlloyTouch from "../../../lib/base/human_sensor/assets/alloy_touch";
import Transform from "../../../lib/base/human_sensor/assets/transformjs/transform";
export default {
    props: {
        enablePush: Boolean
    },
