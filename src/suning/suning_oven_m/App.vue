...
.more-btn {
    ...
    height: 36px;
    top: 132px;
    background-image: url('@{lib}/btn_more@2x.png');
...
.wrapper {
    ...
    .controls {
        ...
        button {
            ...
            .c-stop {
                background-image: url('@{lib}/btn-stop-normal@2x.png');
            }
            .c-model {
                background-image: url('@{lib}/btn-mode-normal@2x.png');
            }
            .c-firing {
                background-image: url('@{lib}/btn-start-normal@2x.png');
            }
        }
    }
}
