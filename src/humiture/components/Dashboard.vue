<template>
  <div class="bg">
    <img ref="pointer" class="pointer" src="../../../lib/base/humiture/assets/instument_pointer.png" />
    <div class="val">
...
<script>
import bg_1 from "../../../lib/base/humiture/assets/instrument_temp.png";
import bg_2 from "../../../lib/base/humiture/assets/instrument_humidity.png";
        ...
        rotate(val) {
            ...
            if (this.type === 1) {
                ...
                if (0 < val && val < 40) {
                    ...
                    if (val <= 0) {
                        angle =
                            MIN_ANGLE + ANGLE_GRID * 2 + ANGLE_GRID / 10 * val;
                    } else {
                        angle =
                            MAX_ANGLE -
                            ANGLE_GRID * 2 +
                            (val - 40) * (ANGLE_GRID / 10);
                    }
                }
            } else {
