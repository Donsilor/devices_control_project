    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <div
            ref="bc"
            :class="[{ 'active': deviceAttrs.temperature == 167 && deviceAttrs.switch_status == 'on' && !isOffline }, 'btn', 'btn-bc center']"/>
        ...
        <div
          ...
          <div
            ref="rs"
            :class="[{ 'active': deviceAttrs.temperature == 370 && deviceAttrs.switch_status=='on' && !isOffline }, 'btn btn-rs center']" />
