        ...
        <div class="wrap-circle">
          ...
          <div 
            ...
            <div 
              ...
              :key="index" 
              :style="{transform: `rotate(${6.78*index-105}deg)`}" 
            ...
            <div
              v-if="isOffline|| loaclAttr.switchStatus == 'off'||loaclAttr.mode=='wind'"
  ...
  methods: {
    ...
    touchend(){
      ...
      .then((res) => {
        if (res) {
          if(res.code == 0) {
            this.loaclAttr.temperature = this.itemTemp
