<template>
    <div id="app">
        ...
        <div class="curtain s1" :class="{}"></div>
...
<style lang="less">
    body {
        ...
        -ms-user-select: none;
        user-select: none;
        background-image:linear-gradient(-180deg, #018dfe 0%, #46bcff 85%);
    }
    ...
    .curtain{
        ...
        transition: all 1s;
        &.s1{
            background-image: url(assets/img_curtain_opened.png)
        }
        &.s2{
            background-image: url(assets/img_curtain_opening.png)
        }
        &.s3{
            background-image: url(assets/img_curtain_closed.png)
        }
    }
</style>
<script>
