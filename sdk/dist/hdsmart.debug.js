/*! hdsmart.debug.js built at 2017-11-2 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bridge_socket__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constant__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helper__ = __webpack_require__(84);
...
__WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].io.on('connect', function () {
    console.log('ready');
    if (!__WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].isReady) {
        Object(__WEBPACK_IMPORTED_MODULE_2__event__["b" /* trigger */])(__WEBPACK_IMPORTED_MODULE_3__constant__["a" /* apiList */].ready);
        __WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].isReady = true;
    }
});
...
window.HdSmart = {
    ready: function ready(callback) {
        if (__WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].isReady) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_2__event__["a" /* on */])(__WEBPACK_IMPORTED_MODULE_3__constant__["a" /* apiList */].ready, callback);
        }
    },
    onDeviceListen: function onDeviceListen(callback) {
        __WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].io.on(__WEBPACK_IMPORTED_MODULE_3__constant__["a" /* apiList */].device_change, callback);
    },
    Device: {
        getSnapShot: function getSnapShot(callback) {
            __WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].send(__WEBPACK_IMPORTED_MODULE_3__constant__["a" /* apiList */].device_getsnapshot, '', callback);
        },
        control: function control(options, onSuccess, onFailure) {

            var dataOptions = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({
                req_id: Object(__WEBPACK_IMPORTED_MODULE_4__helper__["c" /* guid */])(),
                timestamp: Date.now(),
                params: {}
            }, options);

            if (options.nodeid) {
                dataOptions.token = Object(__WEBPACK_IMPORTED_MODULE_4__helper__["b" /* getToken */])();
            }

            dataOptions.params.device_uuid = Object(__WEBPACK_IMPORTED_MODULE_4__helper__["a" /* getDeviceUUID */])();

            __WEBPACK_IMPORTED_MODULE_1__bridge_socket__["a" /* default */].send(__WEBPACK_IMPORTED_MODULE_3__constant__["a" /* apiList */].device_control, dataOptions, function (data) {
                if (options.nodeid) {
                    if (data.code === 0) {
                        onSuccess(data);
                    } else {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client__ = __webpack_require__(60);
...
function off(type, callback) {
    ...
    var cbs = _cbs[type] || [];
    var i;
    while (cbs && ~(i = cbs.indexOf(callback))) {
        cbs.splice(i, 1);
    }
}
...
var apiList = {
    ...
    ui_settouchrect: 'UI.setTouchRect',
    ui_toast: 'UI.toast',
    ui_toggleheadandfoot: 'UI.toggleHeadAndFoot',

    util_dispatchevent: 'Util.dispatchEvent',
    util_getnetworktype: 'Util.getNetworkType',
    util_post: 'Util.post',
    util_reload: 'Util.reload',
    util_sendnotification: 'Util.sendNotification'
};
...
/* harmony export (immutable) */ __webpack_exports__["c"] = guid;
/* harmony export (immutable) */ __webpack_exports__["a"] = getDeviceUUID;
/* harmony export (immutable) */ __webpack_exports__["b"] = getToken;
/* unused harmony export getDeviceName */
/* unused harmony export getDeviceCategory */
/* unused harmony export log */
/* unused harmony export covertToNumber */
...
function log(apiName, data, result) {
